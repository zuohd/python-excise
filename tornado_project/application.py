...
class Application(tornado.web.Application):
    def __init__(self):
        handlers = [
            ...
            (r'/asyncstudents1',student.CallbackStudentsHandler),
            (r'/asyncstudents2', student.CoroutineStudentsHandler),
            (r'/asyncstudents3', student.RefineCoroutineStudentsHandler),
